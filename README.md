...
This is a fork of the repository for the Azure Red Hat OpenShift Workshop website.
...
- You hack use the makefile file if you want to create a container image
